                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            var viewForm = '<a href="/booth/' + row.id + '" class="edit btn btn-primary btn-sm"><i class="material-icons">info</i></a>';
                            return '<a href="/booth/' + row.id + '/edit' + ' " class="edit btn btn-warning btn-sm"><i class="material-icons">edit_square</i></a>' + viewForm;
                        }
                    },
                ]
            });
