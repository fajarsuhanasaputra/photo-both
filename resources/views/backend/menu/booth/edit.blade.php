    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="RegisterValidation" method="post" action="{{route('booth.update', $data->id)}}" enctype="multipart/form-data">
                    {{ csrf_field()}}
                    {{ method_field('put') }}
                    <div class="card ">
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="booth_name" id="booth_name" required class="form-control" value="{{ $data->booth_name }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" id="address" required class="form-control" value="{{ $data->address }}">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" type="radio" value="{{ $pc }}" name="pricing" {{ $data->pricing === $pc ? 'checked' : '' }}> {{ $pc }}
                                                        <span class="circle">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="ml-1 form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" name="frame[]" type="checkbox" value="{{ $fr->id }}" @foreach($booth_frame as $i) @if($fr->id == $i) checked @endif @endforeach>
                                                        {{ $fr->name }}
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="ml-1 form-check">
                                                    <label class="form-check-label">
                                                        <input class="form-check-input" name="package[]" type="checkbox" value="{{ $fr->id }}" @foreach($booth_package as $i) @if($fr->id == $i) checked @endif @endforeach>
                                                        {{ $fr->package_name }}
                                                        <span class="form-check-sign">
                                                            <span class="check"></span>
                                                        </span>
