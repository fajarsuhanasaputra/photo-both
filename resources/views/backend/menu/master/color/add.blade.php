    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <form id="RegisterValidation" method="post" action="{{route('color.store')}}" enctype="multipart/form-data">
                    {{ csrf_field()}}
                    <div class="card ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="color" name="hex" id="exampleName" class="form-control">
                                        @if($errors->has('hex'))
                                        <em class="invalid-feedback">
                                            {{ $errors->first('hex') }}
                                        </em>
