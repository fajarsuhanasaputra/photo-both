                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ $dt->img_frame_left}}" alt="..." height="70px" weight="70px"></td>
                                        <td><img src="{{ $dt->img_frame_right }}" alt="..." height="70px" weight="70px"></td>
                                        <td>{{ $dt->name }}</td>
                                        <td>{{ $dt->size }}</td>
                                        ...
                                        <td class="td-actions text-right">
                                            <form action="{{ route('frame.destroy', $dt->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                                <a href="{{ route('frame.edit', $dt->id) }}" class="btn btn-link btn-warning btn-just-icon edit" >
